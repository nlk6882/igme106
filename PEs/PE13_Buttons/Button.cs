...
namespace PE_MG_Buttons
{
    ...
    public delegate void OnButtonLeftClickDelegate();
    public delegate void OnButtonRightClickDelegate();
    ...
    public class Button
    {
        ...
        /// </summary>
        public event OnButtonLeftClickDelegate OnButtonLeftClick;
        public event OnButtonRightClickDelegate OnButtonRightClick;
